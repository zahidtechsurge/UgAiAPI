...
namespace AmazonFarmer.Core.Application.Exceptions
{
    ...
    {
        private static readonly ResourceManager _resourceManager = new ResourceManager("AmazonFarmer.Core.Application.Exceptions.EnglishResources", typeof(EnglishResources).Assembly);

        public static string GetString(string key)
        {
            return _resourceManager.GetString(key);
        }
        public const string errorOccuredWhileAddingUser = "An Error Occured While Adding User";
