...
namespace AmazonFarmer.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250522060336_added new column for transaction confirmation count")]
    partial class addednewcolumnfortransactionconfirmationcount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AmazonFarmer.Core.Domain.Entities.TblUser", b =>
                {
                    ...
                    b.Property<string>("ShipToPartyCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ShipToPartyName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AmazonFarmer.Core.Domain.Entities.tblCropGroup", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AmazonFarmer.Core.Domain.Entities.tblEmailNotificationTranslations", b =>
                {
                    b.Property<int>("RecID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DeviceBody")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FCMBody")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("EmailNotificationTranslations");
                });
            ...
            modelBuilder.Entity("AmazonFarmer.Core.Domain.Entities.tblNotification", b =>
                {
                    ...
                    b.Property<int?>("FarmApplicationID")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("GoogleMapLinkWithCoordinated")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("IsClicked")
                        .HasColumnType("bit");

                    b.Property<string>("NewPaymentDueDate")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("NotificationRequestStatus")
                        .HasColumnType("int");

                    b.Property<long?>("OrderID")
                        .HasColumnType("bigint");

                    b.Property<string>("PKRAmount")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ReasonCommentBox")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("ReasonsDropdownID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AmazonFarmer.Core.Domain.Entities.tblTransaction", b =>
                {
                    ...
                    b.Property<int?>("TransactionStatusCheckAttempts")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AmazonFarmer.Core.Domain.Entities.tblUnitOfMeasure", b =>
                {
                    ...
                    b.Property<decimal?>("UnitOfMeasureSales")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("UnitofMeasureReporting")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("AmazonFarmer.Core.Domain.Entities.TblOrders", b =>
                {
                    ...
                    b.HasOne("AmazonFarmer.Core.Domain.Entities.tblCropGroup", "Crop")
                        .WithMany("Orders")
                    ...
                    b.HasOne("AmazonFarmer.Core.Domain.Entities.tblCrop", null)
                        .WithMany("Orders")
                        .HasForeignKey("tblCropID");
            ...
            modelBuilder.Entity("AmazonFarmer.Core.Domain.Entities.tblEmailNotificationTranslations", b =>
                {
                    b.HasOne("AmazonFarmer.Core.Domain.Entities.tblLanguages", "Languages")
                        .WithMany("EmailNotificationTranslations")
                        .HasForeignKey("LanguageCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AmazonFarmer.Core.Domain.Entities.tblEmailNotifications", "Notification")
                        .WithMany("EmailNotificationTranslations")
            ...
            modelBuilder.Entity("AmazonFarmer.Core.Domain.Entities.tblNotification", b =>
                {
                    ...
                    b.HasOne("AmazonFarmer.Core.Domain.Entities.tblReasons", "Reason")
                        .WithMany("Notifications")
                        .HasForeignKey("ReasonsDropdownID");
            ...
            modelBuilder.Entity("AmazonFarmer.Core.Domain.Entities.tblEmailNotifications", b =>
                {
                    b.Navigation("EmailNotificationTranslations");
