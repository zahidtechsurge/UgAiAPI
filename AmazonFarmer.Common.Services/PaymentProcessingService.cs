...
namespace AmazonFarmer.Common.Services
{
    public class PaymentProcessingService
    {
        ...
        public PaymentProcessingService(IRepositoryWrapper repoWrapper, NotificationService notificationService, WsdlConfig wsdlConfig)
        {
